...
function Professor({ avatar, name, role, experience, phone }) {
  return (
    <div className="my-4">
      <div className="grid grid-cols-1 md:grid-cols-5 items-center justify-between gap-8 md:gap-16 p-6 bg-gray-50 rounded-lg shadow-lg">
        ...
        <div className="col-span-1">
          <Link
            to={phone}
            className="flex items-center justify-center gap-2 font-bold text-green-700 hover:text-green-500 transition ease-linear duration-200"
          >
